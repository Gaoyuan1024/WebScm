<template>
  <div class="table-container">
    ...
    <table-list
      ...
      :search-child-form="searchChildForm"
      :search-child-data="searchChildData"
  ...
  data() {
    return {
      ...
      TopAction: {
        ...
        right: [{ label: '设置拖拽列', type: 'primary', dropdown: true }],
      },
      columns: [
  ...
  methods: {
    ...
    resetForm() {
      ...
      Object.assign(
        ...
        this.$options.data.call(this).searchData
      )
      Object.assign(
        this.$data.searchChildData,
        this.$options.data.call(this).searchChildData
      )
    },
