...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        component: (resolve) =>
          require(['@/views/vab/permissions/index'], resolve),
        meta: {
          title: '角色权限',
      ...
      // },
      {
        ...
        component: (resolve) => require(['@/views/vab/table/index'], resolve),
        name: 'Table',
        meta: {
          title: '表格',
          permissions: ['admin'],
      ...
      },
      {
        ...
        component: (resolve) => require(['@/views/vab/detail/index'], resolve),
      ...
      // },
      {
        ...
        component: (resolve) => require(['@/views/vab/map/index'], resolve),
        name: 'Map',
        meta: {
          title: '地图',
          permissions: ['admin'],
      ...
      // },
      {
        ...
        component: (resolve) => require(['@/views/vab/editor/index'], resolve),
        meta: {
          title: '富文本编辑器',
          permissions: ['admin'],
          badge: 'New',
  ...
  },
  {
    ...
    children: [
      ...
      //   component: () =>
      //     import('@/views/personnelManagement/printManagement/index'),
      //   meta: { title: '打印配置', badge: 'New' },
      // },
    ],
  },
  // {
